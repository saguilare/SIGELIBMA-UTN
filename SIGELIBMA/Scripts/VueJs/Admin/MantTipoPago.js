...
var vm = new Vue({
    ...
    methods: {
        ...
        getInitData: function () {
            $.ajax({
                url: urlRoot + 'MantTipoPago/ObtenerInitData',
                type: 'get',
                dataType: 'json',
        ...
        getTipos: function () {
            $.ajax({
                url: urlRoot + 'MantTipoPago/ObtenerTodos',
                type: 'get',
                dataType: 'json',
                success: function (result) {
                    if (result.EstadoOperacion) {
        ...
        agregar: function () {
            vm.displaySpinner(true,'Agregando Tipo Pago');
            $.ajax({
                url: urlRoot + 'MantTipoPago/Agregar',
                type: 'post',
                dataType: 'json',
                data: vm.tipo,
                success: function (result) {
        ...
        modificar: function () {
            ...
            vm.displaySpinner(true, 'Editando Tipo Pago');
            $.ajax({
                url: urlRoot + 'MantTipoPago/Modificar',
                type: 'post',
                dataType: 'json',
                data: vm.modalObject,
                success: function (result) {
        ...
        eliminar: function (tipo) {
            vm.displaySpinner(true, 'Desabilitando Tipo Pago');
            tipo.estado = 0;
            $.ajax({
                url: urlRoot + 'MantTipoPago/Desabilitar',
                type: 'post',
                dataType: 'json',
                data: tipo,
                success: function (result) {
