...
var data = {};
data.estadoCaja = { codigo: 0, descripcion:"", estado:0 };
data.estadosCaja = [];
data.estados =[];
...
var vm = new Vue({
    ...
    methods: {
        ...
        getInitData: function () {
            $.ajax({
                url: urlRoot + 'MantEstadoCaja/ObtenerInitData',
                type: 'get',
                dataType: 'json',
                success: function (result) {
                    if (result.EstadoOperacion) {
                        vm.estadosCaja = result.EstadosCaja;
                        vm.estados = result.Estados;
                        vm.items = vm.estadosCaja;
                        vm.filteredItems = vm.estadosCaja;
                        vm.buildPagination();
                        vm.selectPage(1);
                    } else {
        ...
        getEstadosCaja: function () {
            $.ajax({
                url: urlRoot + 'MantEstadoCaja/ObtenerTodos',
                type: 'get',
                dataType: 'json',
                success: function (result) {
                    if (result.EstadoOperacion) {
        ...
        agregar: function () {
            vm.displaySpinner(true,'Agregando Estado Caja');
            $.ajax({
                url: urlRoot + 'MantEstadoCaja/Agregar',
                type: 'post',
                dataType: 'json',
                data: vm.estadoCaja,
                success: function (result) {
                    if (result.EstadoOperacion) {
                        vm.getEstadosCaja();     
                        vm.estadoCaja = { codigo: 0, descripcion:"", estado:0 };
                    } else {
        ...
        modificar: function () {
            ...
            vm.displaySpinner(true, 'Editando Estado Caja');
            $.ajax({
                url: urlRoot + 'MantEstadoCaja/Modificar',
                type: 'post',
                dataType: 'json',
                data: vm.modalObject,
                success: function (result) {
        ...
        eliminar: function (estadoCaja) {
            vm.displaySpinner(true, 'Desabilitando Estado Caja');
            estadoCaja.estado = 0;
            $.ajax({
                url: urlRoot + 'MantEstadoCaja/Desabilitar',
                type: 'post',
                dataType: 'json',
                data: estadoCaja,
                success: function (result) {
        ...
        openEditModal: function (estadoCaja) {
            vm.activateAlertModal('','',false);
            vm.modalObject = estadoCaja;
