...
namespace SIGELIBMA.Controllers
{
    ...
    public class MantTipoTransaccionController : Controller
    {
        ...
        {
            ViewBag.Title = "Tipo Transaccion";
            return View();
        }
        ...
        public JsonResult ObtenerPorId(EstadoModel param)
        {
            try
            {
                TipoTransaccion tipo = servicio.ObtenerPorId(new TipoTransaccion { Codigo = param.Codigo });
        ...
        public JsonResult Desabilitar(EstadoModel param)
        {
            try
            {
                ...
                resultado = servicio.Desabilitar(new TipoTransaccion
                {
                    Codigo = param.Codigo,
        ...
        public JsonResult Modificar(EstadoModel param)
        {
            ...
            {
                bool resultado = false;
                resultado = servicio.Modificar(new TipoTransaccion
                {
                    Codigo = param.Codigo,
                    Descripcion = param.Descripcion,
                    Estado = param.Estado
        ...
        public JsonResult Agregar(EstadoModel param)
        {
            ...
            {
                bool resultado = false;
                resultado = servicio.Agregar(new TipoTransaccion
                {
                    Codigo = param.Codigo,
                    Descripcion = param.Descripcion,
                    Estado = param.Estado
